...
const remainingAfterBillsEl = document.getElementById('remainingAfterBills');
...
function render() {
  ...
  plannedSavingsEl.textContent = formatCurrency(suggestedSavings);
  remainingAfterBillsEl.textContent = formatCurrency(remainingBudget);
  billCountEl.textContent = state.bills.length.toString();
